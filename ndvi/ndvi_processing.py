...
# input_images_folder = 'falso_luzNatural_dia/'
# output_images_folder = 'imagens_processadas/'+imput_images_folder

input_images_folder = './imagens/detected_faces/falsos/foto_tela_filtro/'
output_images_folder = './imagens/imagens_processadas/'+input_images_folder
...
# Calcula o NDVI usando
# os canais vermelho e azul. 
# O NDVI é uma medida baseada na diferença
# entre o infravermelho próximo 
...
def ndvi_calculate(image):
    ...
    # (b.astype(float) - r) / bottom ORIGINAL
    return ndvi
...
if __name__ == "__main__":
    images_to_process = get_filenames_from_folder(input_images_folder)
    check_and_create_folder(output_images_folder)
    for image_name in images_to_process:
        image_path = input_images_folder + image_name
